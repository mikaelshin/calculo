...
\textbf{Base para os exercícios 1 e 2:}
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.25]{images/areadeseccao.png}
    \end{figure}
    \begin{align*}
     A\left(r,a\right)
...
\textbf{Exercício 1:}
    \begin{figure}
        \centering
        \includegraphics[scale = 0.206]{images/ex1.png}
    \end{figure} 
    \begin{align*}
...
Caso particular: para d = 0 
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.16]{images/ex1caso1.png}
    \end{figure} 
    \begin{align*}
     A
...
Caso particular: para d = 2R
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.2]{images/ex1caso2.png}
    \end{figure} 
    \begin{align*}
     A 
...
Caso particular: para d = R
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.16]{images/ex1caso3.png}
    \end{figure} 
    \begin{align*}
     A
...
\textbf{Exercício 2:}
    ...
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.54]{images/triangulo.png}
    \end{figure}
    $R$ para $a > 0$
    \begin{align*}
    ...
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.18]{images/ex2caso1.png}
    \end{figure}
    \begin{align*}
     A 
     & \ = \ A(r, 0) - A(R, R - \alpha r)\\
...
\textbf{Base para o exercício 3}
    ...
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.33]{images/ex3pitagoras.png}
    \end{figure} 
    \begin{align*}
    ...
    \begin{figure}[!htb]
        \centering
         \includegraphics[scale = 0.23]{images/ex3cosseno.png}
    \end{figure} 
    \begin{align*}
        c^{2}
...
\textbf{Exercício 3:}
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.22]{images/ex3.png}
    \end{figure} 
    \begin{align*}
     l_i^{2}
